...
def main(arg_dict):
    ...
    for molecule in range(number_molecules):
        ...
        molecule_dataContainer = reduced_atom.fragment[molecule]
        ...
        for level in levels[molecule]:
            ...
            if level == 'polymer' or 'residue':
                ...
                force_matrix, torque_matrix = LF.get_matrices(molecule_dataContainer, level)
                ...
                ## Conformational entropy for residues and polymers based on distributions of dihedral angles
                ...
                ## Conformational entropy is not relevent for the united atom level as there are no internal dihedral angles in a united atom bead.
